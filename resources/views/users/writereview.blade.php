    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <form method="POST" action="{{ route('process.write.review') }}" class="review ftco-bg-dark p-3 p-md-5">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt-4">
                            <div class="radio">
                                <button type="submit" name="submit" class="btn btn-primary py-3 px-4">Write A Review</button>
                            </div>
                        </div>
                    </div>
                </form>
