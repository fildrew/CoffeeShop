    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('add.cart', $product->id)}}">
            ...
            @if(isset(Auth::user()->id))
                ...
                @else
                    <button style="background-color:black"   type="submit" name="submit" class="btn btn-primary py-3 px-5" disabled>Added to Cart</button>
                @endif
            @endif
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="menu-entry">
                        <a href="#" class="img" style="background-image: url({{ asset('assets/images/'.$relatedProduct->image.'') }});" ></a>
